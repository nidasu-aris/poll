...
<?php echo $this->Form->create('PollLog');?>
	<fieldset>
		<legend><?php echo __('Admin Edit Poll Log'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PollLog.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PollLog.id'))); ?></li>
